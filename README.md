...
python load_data.py --input raw_metadata.csv --output cleaned_data.csv

### 2. 피처 전처리 & 정제  
python preprocessing.py --input cleaned_data.csv --output features.csv

### 3. 모델 학습 / 예측  
python MultiModal.py --data features.csv --mode train
